...
public class S06_NaiveTriangle : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 vertexA = new Vector2(150, 220);
    [SerializeField] private Vector2 vertexB = new Vector2(40, 80);
    [SerializeField] private Vector2 vertexC = new Vector2(100, 160);
    [SerializeField] private Color fillColor = new Color(0.5f, 0.8f, 1f, 1f);
